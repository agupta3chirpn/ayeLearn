...
const Learners = () => {
  ...
  const handleDeleteLearner = async (learnerId) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setSuccessMessage(`Learner "${learnerToDelete?.first_name} ${learnerToDelete?.last_name}" deleted successfully!`)
  ...
  const handleDeleteConfirm = () => {
    if (learnerToDelete) {
      handleDeleteLearner(learnerToDelete.id)
    }
  }
  ...
  return (
    <AdminLayout>
      ...
      <ConfirmPopup
        ...
        message={`Are you sure you want to delete "${learnerToDelete?.first_name} ${learnerToDelete?.last_name}"?\n\nThis action cannot be undone.`}
        type="confirm"
        confirmText="Delete"
        cancelText="Cancel"
      />
      ...
      <ConfirmPopup
        ...
        type="success"
        autoClose={true}
        redirectAfter={() => navigate('/learners')}
      />
    </AdminLayout>
  )
}
